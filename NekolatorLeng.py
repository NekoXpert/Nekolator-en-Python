...
#Introducción
print("Bienvenido, Estimado Alumno de CERTUS, en este programa podras sacar el promedio final del curso de Lenguaje.")
print("¡Empezemos!")
print("")
#Entrada
...
print("")
#Proceso
promleng = float((nota1*0.15) + (nota2*0.20) + (nota3*0.30) + (nota4*0.35))

#Salida
print("Tu promedio final es: ",promleng)
